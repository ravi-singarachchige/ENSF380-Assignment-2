...
public class SupplyTest {
     ...
     * - Current result: Supply type is "Blanket", The quantity is 5.
    ...
    /*
     * testGetFirstName:
     * - What we need: To ensure the "getType()" method correctly returns the actual
     * Supply type.
     * - Current result: "Blanket".
    ...
    /*
     * testSetType():
     * - What we need: To ensure the "setType()" method correctly updates the Supply
     * type.
     * - Current result: "Blanket".
    ...
    /*
     * testGetQuantity():
     * - What we need: To ensure the "getQuantity()" method correctly returns the
    ...
    /*
     * testSetQuantity():
     * - What we need: To ensure the "setQuantity" method correctly updates the
     * Supply quantity.
     * - Current result: 5.
     * - Expected result: 20.
     */
